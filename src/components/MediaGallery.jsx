  ...
  return (
    <div className="mt-4 p-3 border-top border-tertiary">
      ...
      <div className="d-flex gap-2 justify-content-around">
        <img
          src="src/assets/media-img-1.jpg"
          alt="media1"
          className="rounded-2"
          width="75"
          height="70"
        ...
        />
        <img
          src="src/assets/media-img-2.jpg"
          alt="media2"
          className="rounded-2"
          width="75"
          height="70"
        ...
        <div
          ...
          style={{
            width: '75px',
            height: '70px',
            backgroundImage: 'url(src/assets/doot-prfile-img.jpg)',
        ...
        >
          <span
            ...
            //   dispatch(UpdateSidebarType("SHARED"));
            // }}
            className="bg-dark opacity-25 p-4 rounded-2"
          >
            +15
          </span>
        </div>
