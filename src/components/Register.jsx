    ...
    <div className="logout-page d-flex" style={{ width: "100vw", height: "100%" }}>
      ...
      <div className="logout-box py-4 pt-5 h-100 d-grid justify-content-center align-items-center flex-grow-1">
        <div className="d-flex flex-column  justify-content-center align-items-center" style={{ width: "31vw" }}>
          <h4 className="fw-bold mb-2 fs-1">Register Account</h4>
          <p className="text-secondary mb-5" style={{ fontFamily: "sans-serif" }}>Get your free Doot account now.</p>
          <form className="d-flex flex-column text-start w-100 p-3 gap-3">
            <label htmlFor="username">Email</label>
            <input type="email" placeholder="Enter Email" className="form-control shadow-none" />
            ...
            <div className='d-flex'>
              <p>By registering you agree to the Doot <span className='text-success'>Terms of Use</span></p>
            </div>
            <button type="submit" className="btn btn-success">Register</button>
            <div className='d-flex justify-content-center mt-4'>
              <div className='signup-ruler'></div>
              <div className='w-100 text-center'><p>Sign up using</p></div>
              <div className='signup-ruler'></div>
            </div>
          ...
          <p className=" mt-3 mb-5">Already have an account ?  <a href="#" className="text-primary text-success pointer">Login</a></p>
        </div>
      </div>
    </div >
  );
